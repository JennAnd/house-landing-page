...
//             <p className="text-section-body text-section-body-right">
...
//             <p className="text-section-body text-section-body-left">
  ...
  return (
    <section className="text-section">
      <div className="text-section-grid">
        ...
        <p className="text-section-intro">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ac
          erat tempor, fringilla nunc vitae, laoreet velit. Suspendisse eu odio.
        </p>
